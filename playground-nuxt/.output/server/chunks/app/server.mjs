import { version, hasInjectionContext, getCurrentInstance, inject, ref, watchEffect, watch, useSSRContext, createApp, reactive, unref, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, h, isReadonly, defineAsyncComponent, isRef, isShallow, isReactive, toRaw } from 'vue';
...
const revive_payload_server_xL5CFCmX2N = /* @__PURE__ */ defineNuxtPlugin({
...
const unhead_gcbLN4hcd5 = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  setup(nuxtApp) {
...
const router_NKv7ptg34H = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:router",
  enforce: "pre",
  setup(nuxtApp) {
...
const plugin_BETRc1pcCJ = /* @__PURE__ */ defineNuxtPlugin((_nuxtApp) => {
  console.log("Plugin injected by my-module!");
});
const _plugins = [
  revive_payload_server_xL5CFCmX2N,
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-43c3d405.mjs').then((r) => r.default || r));
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@3.5.1_@types+node@18.14.6_eslint@8.41.0_rollup@3.22.0_typescript@5.0.4/node_modules/nuxt/dist/app/components/nuxt-root.vue");
